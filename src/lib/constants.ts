...
export const MINIMAL_SELECTOR_ITEM_WIDTH = 34;
export const MINIMAL_SELECTOR_ITEM_HEIGHT = 36;

export const CONTROL_INPUT_WIDTH = 40;
export const CONTROL_INPUT_HEIGHT = 20;

...
export type PngGafImporterConfig = GafImporterConfig & {
...
export type PngGafImageImporter = GafImageImporter<'png', PngGafImporterConfig>;

// Implementation: ---------------------------------------------------------------------------------

const decoder = PNG_IMAGE_DECODER;
const imageCompiler = new SimpleImageCompiler();

export const PNG_GAF_IMAGE_IMPORTER: PngGafImageImporter = {
  format: 'gaf',
  subKind: 'png',
  supportedFileExts: decoder.supportedFileExts,
  title: 'PNG Importer',
  ...
  createUserImage: decoder.decodeFile,
